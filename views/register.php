...
<head>
    ...
    <title>Inscription - CryptoTrade</title>
...
<div class="card shadow login-card animate__animated animate__fadeInUp w-100" style="max-width: 400px;">
    ...
    <h1 class="mb-4 fw-bold text-uppercase text-center">Inscription CryptoTrade</h1>
    ...
    <div class="text-center mt-3">
        <span class="form-text">Déjà un compte ?</span><br>
